...
pub use encoding::{
    AdcHibernateDelay, AdcMode, OpMode, WatchdogPeriod, CHARGE_MIN_VIN_UV, NABU_BAT_OVP_UV,
    NABU_QC3_BAT_VOLT_MAX_UV, NABU_VBAT_FLOAT_UV, NABU_VBAT_NON_FFC_UV, SWITCHING_HEADROOM_UV,
    SWITCHING_MIN_VIN_UV, VBAT_FLOAT_SOFT_MAX_UV, VBAT_TAPER_IIN_UA, VBAT_TAPER_MARGIN_UV,
...
pub use guard::{
    bypass_strikes_expired, die_temp_usable, evaluate, resolve_bypass, BypassResolution,
    GuardAction, GuardLimits, BYPASS_DENIED_STRIKES_BEFORE_STOP, DIE_TEMP_MAX_PLAUSIBLE_DC,
    TEMP_REDUCE_HYST_DC, VBAT_REDUCE_HYST_UV,
};
pub use hvdcp_policy::{
    apsd_elevate_path, input_present_from_vin, should_renegotiate_on_input_edge,
    should_schedule_superuser_retry, superuser_retry_due, ApsdElevate, HVDCP_ERR_USBIN_UNAVAILABLE,
    HVDCP_PHASE_DONE, HVDCP_PHASE_FAILED, HVDCP_PHASE_FIVE_V_BYPASS, HVDCP_PHASE_IDLE,
    HVDCP_SUPERUSER_RETRY_MAX, HVDCP_SUPERUSER_RETRY_MS, VIN_UNPLUG_MAX_UV,
};
pub use qc35_auth::{
    decide_qc35_auth_attempt, qc35_authenticate_outcome, qc35_cap_window, qc35_detect_window,
    qc35_icl_raw, qc35_power_limit_w, Qc35AuthGate, Qc35AuthPulse, Qc35AuthResult,
    ...
    QC35_PREP_MAX_INC, QC35_SRC_CAP_PULSES, QC35_STEP_UV, QC35_VIN_POLL_MS,
};
